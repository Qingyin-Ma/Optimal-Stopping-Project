...
global beta gam_x gam_y a gridpoints mu_f gam_f gridsize mugrid gamgrid gamsize musize N draws;
...
N = 1000;     % number of MC samples used to compute the integration
...
draws = randn(N, 2);  % initial Monte Carlo samples
